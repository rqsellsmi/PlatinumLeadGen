-- ==============================================================
-- RE/MAX Platinum — RESET + FULL SETUP (paste into Neon SQL Editor)
-- Use this when a previous attempt left the database half-created
-- (e.g. 'type "lead_status" already exists'). It DROPS everything in
-- the public schema, then recreates all tables and seeds the 4 cities.
-- Safe ONLY before you have real data. Run once.
-- ==============================================================
