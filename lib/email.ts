 ...
 */
/**
 * The launch/onboarding invite. Also the place the 30% referral is disclosed:
 * turning on availability in portal settings IS the agent's acceptance of it,
 * so the term has to be stated plainly here, before they can act on it — hence
 * the callout box rather than a line of body copy they can skim past.
 */
export function agentInviteEmail(d: AgentInviteEmailData): SendEmailArgs {
  const html = shell(
    'Your agent portal is ready',
    `<h1 style="margin:0 0 12px;font-size:22px;color:${BRAND_BLUE};">Your agent portal is ready</h1>
     <p style="font-size:15px;line-height:1.5;">Hi ${escapeHtml(d.agentName)}, your RE/MAX Platinum Lead Generation Website Agent Portal is ready. Choose a password to complete your set-up.</p>
     <p style="margin:24px 0;">${button(d.inviteUrl, 'Choose your password')}</p>
     <p style="font-size:15px;line-height:1.5;">Once you're logged in, the <strong>Help</strong> page will give you guidance on how the system works.</p>
     <p style="font-size:15px;line-height:1.5;">If you agree to following the system and would like to receive leads, go to <strong>Settings</strong> and turn on your lead routing availability.</p>
     <div style="margin:20px 0;padding:14px 16px;background:#f5f7fa;border-left:3px solid ${BRAND_BLUE};">
       <p style="margin:0;font-size:15px;line-height:1.5;color:#1a1a1a;">Each lead generated by the system is a <strong>30% referral back to RE/MAX Platinum</strong>. By turning on your availability you are agreeing to this referral.</p>
     </div>
     <p style="font-size:13px;line-height:1.5;color:#64748b;">This invitation is personal to you and expires in 7 days. If you weren't expecting it, let the office know.</p>`,
  );
  const text = `Hi ${d.agentName},

Your RE/MAX Platinum Lead Generation Website Agent Portal is ready. Choose a password to complete your set-up: ${d.inviteUrl}

Once you're logged in, the Help page will give you guidance on how the system works.

If you agree to following the system and would like to receive leads, go to Settings and turn on your lead routing availability.

Each lead generated by the system is a 30% referral back to RE/MAX Platinum. By turning on your availability you are agreeing to this referral.
