  ...
  return (
    ...
    >
      <div className="relative h-52 w-full bg-line-hair">
        ...
        {/* Save heart — signed-out clicks open sign-in; overlaps nothing above. */}
        <div className="absolute right-2 top-2 z-[1]">
          <FavoriteButton listingKey={listing.listingKey} next={href} />
        </div>
        {/* Real status badge — AUC/pending must NOT read as a plain "For Sale". */}
        <span className="absolute right-2 top-12 flex flex-col items-end gap-1">
          {variant === 'sale' ? (
            <span
