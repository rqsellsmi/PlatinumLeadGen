...
export default function ThankYouClient({
  ...
  // Which AVM provider produced this estimate (set on the valuation row per the
  // VALUATION_PROVIDER env var at capture time). Shown to the seller directly
  // under the value so it's clear the number is the provider's automated
  // estimate — the market sections below come from the Realcomp MLS feed.
          ...
          <div className="mt-5 rounded-2xl bg-charcoal p-6 text-white sm:p-8">
            ...
            {valuationSource ? (
              <p className="mt-4 text-[11px] text-mute-lighter">
                This estimated value is generated by {valuationSource}. The market data,
                comparable sales, and listings shown below come from the Realcomp MLS.
              </p>
            ) : null}
